...
def compile_network(env, target, model, start_pack, stop_pack):
    ...
    weight_shape = (1, 1)
    padding_shape = (0, 0)
    data_shape = (batch_size, in_channels, in_pixel, in_pixel)
    ...
    simple_net = relay.nn.conv2d(data=data, weight=weight, kernel_size=weight_shape, channels=out_channels, padding=padding_shape)
...
def tune_and_evaluate(tuning_opt):
    ...
    # for tsk in reversed(tasks):
        ...
        print(cnt, tsk.args[0], tsk.args[1])
        # print(
        #     "({}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {})".format(
        #         batch,
        #         height,
